...
USE_PUSH=$USE_PUSH
ANDROID_UPLOAD_STORE_FILE=debug.keystore
ANDROID_UPLOAD_KEY_ALIAS=androiddebugkey
ANDROID_UPLOAD_STORE_PASSWORD=android
ANDROID_UPLOAD_KEY_PASSWORD=android" > $PROJECT_HOME/env/.env.debug
...
ANDROID_UPLOAD_KEY_ALIAS=androiddebugkey
ANDROID_UPLOAD_STORE_PASSWORD=android
ANDROID_UPLOAD_KEY_PASSWORD=android" > $PROJECT_HOME/env/.env.staging
...
ANDROID_UPLOAD_KEY_ALIAS=androiddebugkey
ANDROID_UPLOAD_STORE_PASSWORD=android
ANDROID_UPLOAD_KEY_PASSWORD=android" > $PROJECT_HOME/env/.env.product
